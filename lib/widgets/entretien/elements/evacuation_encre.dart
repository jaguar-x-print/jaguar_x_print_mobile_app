...
class EvacuationEncreCard extends StatefulWidget {
  final Function(List<File?>) onImagesPicked;
  final Function(String) onCommentChanged;

  const EvacuationEncreCard({
    super.key,
  ...
  @override
  State<EvacuationEncreCard> createState() => _EvacuationEncreCardState();
}

class _EvacuationEncreCardState extends State<EvacuationEncreCard> {
