...
import 'package:flutter_image_compress/flutter_image_compress.dart'; // Nouveau package

class PhotoStationEncreCard extends StatefulWidget {
  final Function(List<File?>) onImagesPicked;
  final Function(String) onCommentChanged;

  const PhotoStationEncreCard({
    super.key,
  ...
  @override
  State<PhotoStationEncreCard> createState() => _PhotoStationEncreCardState();
}

class _PhotoStationEncreCardState extends State<PhotoStationEncreCard> {
  final List<File?> _images = List.filled(5, null);
  int _imageCount = 0;
  final TextEditingController _commentController = TextEditingController();
  final ImagePicker _picker = ImagePicker();
  bool _isCompressing = false; // Nouvel état pour suivre la compression
    ...
    return Card(
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            Text(
              "4. Photo Station encre, Caps, Wiper, Pompe...",
              style: TextStyle(
